...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the RabidCoin Core repository on GitHub"),
        tr("Services that claim to double your rabidcoins are always ponzi schemes")
    };

...
// Copyright (c) 2021-2023 The RabidCoin Core developers
    ...
    platformStyle(_platformStyle)
{
    ...
    // RabidCoin: load fallback font in case Comic Sans is not available on the system
    ...
    // RabidCoin: load this bundled font for Settings -> Options in case it's not available on the system
    ...
    // RabidCoin: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // RabidCoin: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(platformStyle->SingleColorIcon(":/icons/overview"), tr("&Lambo Yet?"), this);
    ...
    sendCoinsAction = new QAction(platformStyle->SingleColorIcon(":/icons/send"), tr("&Send For Rug"), this);
    sendCoinsAction->setStatusTip(tr("Send coins to a RabidCoin address"));
    ...
    receiveCoinsAction = new QAction(platformStyle->SingleColorIcon(":/icons/receiving_addresses"), tr("&Receive Moon"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rabidcoin: URIs)"));
    ...
    historyAction = new QAction(platformStyle->SingleColorIcon(":/icons/history"), tr("&Where Did My Coins Go?"), this);
    ...
    miningAction = new QAction(platformStyle->SingleColorIcon(":/icons/mining"), tr("&Mine RABID"), this);
    miningAction->setStatusTip(tr("Mine RabidCoin with built-in miner"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RabidCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RabidCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a rabidcoin: URI or payment request"));

    importPrivateKeyAction = new QAction(platformStyle->TextColorIcon(":/icons/address-book"), tr("&Import Private Key..."), this);
    importPrivateKeyAction->setStatusTip(tr("Import a RabidCoin private key"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible RabidCoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addSeparator();
    QAction *websiteAction = new QAction(tr("RabidCoin Website"), this);
    websiteAction->setStatusTip(tr("Visit www.rabidmining.com"));
    connect(websiteAction, &QAction::triggered, []{ QDesktopServices::openUrl(QUrl("https://www.rabidmining.com")); });
    help->addAction(websiteAction);
    QAction *youtubeAction = new QAction(tr("RabidMining YouTube"), this);
    youtubeAction->setStatusTip(tr("Watch RabidMining on YouTube"));
    connect(youtubeAction, &QAction::triggered, []{ QDesktopServices::openUrl(QUrl("https://www.youtube.com/@RabidMining")); });
    help->addAction(youtubeAction);
    help->addSeparator();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to RabidCoin network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("RabidCoin"); // default title

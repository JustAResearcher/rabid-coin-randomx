...
#define QAPP_ORG_NAME "RabidCoin"
#define QAPP_ORG_DOMAIN "rabidcoin.org"
#define QAPP_APP_NAME_DEFAULT "RabidCoin-Qt"
#define QAPP_APP_NAME_TESTNET "RabidCoin-Qt-testnet"

...
void Shutdown()
{
    ...
    RenameThread("rabidcoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // RabidCoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/rabidcoin/rabidcoin>";
    const std::string URL_WEBSITE = "<https://rabidcoin.com>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("rabidcoin-loadblk");
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // RabidCoin: Do we need to do any RPC mining init here?

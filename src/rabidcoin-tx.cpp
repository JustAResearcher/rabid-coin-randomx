...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rabidcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rabidcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rabidcoin transaction") + "\n" +
              "  rabidcoin-tx [options] -create [commands]   " + _("Create hex-encoded rabidcoin transaction") + "\n" +
              "\n";

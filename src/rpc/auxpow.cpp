...
// Copyright (c) 2021-2025 The RabidCoin Core developers
...
void AuxMiningCheck()
{
    ...
    if (IsInitialBlockDownload() && !Params().MineBlocksOnDemand())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD,
                           "RabidCoin is downloading blocks...");
...
static UniValue AuxMiningCreateBlock(const CScript& scriptPubKey)
{
    ...
    // RabidCoin: Never mine witness tx
     ...
     * a single rabidcoind instance, for example when a pool runs multiple sub-

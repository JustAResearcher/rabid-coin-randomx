/* src/config/rabidcoin-config.h.  Generated from rabidcoin-config.h.in by configure.  */
/* src/config/rabidcoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitcoin Core and Rabidcoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitcoin Core and Rabidcoin Core"

...
/** Recommended transaction fee by RabidCoin Core developers
  *
 ...
 *
 *  RabidCoin:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * RabidCoin: Default dust limit that is evaluated when considering whether a
...
/**
 * RabidCoin: Default hard dust limit that is evaluated when considering whether

...
// Rabidcoin: Normally minimum difficulty blocks can only occur in between
...
unsigned int CalculateRabidcoinNextWorkRequired(const CBlockIndex* pindexLast, int64_t nFirstBlockTime, const Consensus::Params& params)
{
...
{
    // Fixed 10,000 RABID block reward forever, no halvings
    return 10000 * COIN;
}
